...
public class ProgressWheel extends View {
    ...
    /**
     * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the view, because this method is called after
     * measuring the dimensions of MATCH_PARENT & WRAP_CONTENT. Use this dimensions to setup the bounds and paints.
     */
    @Override
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (String s : splitText) {
            ...
            canvas.drawText(s, this.getWidth() / 2 - horizontalTextOffset, this.getHeight() / 2 + verticalTextOffset,
                    textPaint);
        }
    }
