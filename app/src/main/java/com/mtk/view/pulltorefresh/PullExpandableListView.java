...
public class PullExpandableListView extends ExpandableListView implements OnScrollListener, IPullToRefresh {
    ...
    public PullExpandableListView(Context context, AttributeSet attrs, int defStyle) {
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
    ...
    public void startRefreshingAndScrollBack() {
        ...
        if (mHeaderViewHeight > 0) {
            ...
            mScroller.startScroll(0, mHeaderViewHeight, 0, 0, 0);
            setSelection(0);
            scrollTo(0, 0);
        }
    ...
    public void setHeaderTipLabel(String pullTip, String readyTip) {
        mHeaderView.setHeaderTipLabel(pullTip, readyTip);
    }

    @Override
    public void setFooterTipLabel(String pullTip, String readyTip) {
        mFooterView.setFooterTipLabel(pullTip, readyTip);
    }
